...
const int MSGQUEUE_BROKER_ATENCION_REQUERIMIENTOS_DISPOSITIVOS = 40;
const int MSGQUEUE_BROKER_ENVIO_MENSAJES_DISPOSITIVOS = 41;	
const int MSGQUEUE_BROKER_REQUERIMIENTOS_SHM = 42;
const int MSGQUEUE_BROKER_SHM_TESTERS = 43;
