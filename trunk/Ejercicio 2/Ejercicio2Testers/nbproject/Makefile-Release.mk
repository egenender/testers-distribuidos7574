...
${OBJECTDIR}/PlanillaTesterA.o: PlanillaTesterA.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlanillaTesterA.o PlanillaTesterA.cpp

${OBJECTDIR}/PlanillaTesterB.o: PlanillaTesterB.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/PlanillaTesterB.o PlanillaTesterB.cpp
