...
Planilla::Planilla(int idTester) : mutex_planilla_general(SEM_PLANILLA_GENERAL), mutex_planilla_local(SEM_PLANILLA_LOCAL + idTester), sem_tester_primero(SEM_TESTER_A), sem_tester_resultado(SEM_TESTER_B) {
...
void Planilla::agregar(int aQuien) {
    ...
    if (this->shm_planilla_local == MAX_DISPOSITIVOS) {
