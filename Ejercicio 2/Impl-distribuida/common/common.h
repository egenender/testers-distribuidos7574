...
const int MSGQUEUE_ORDENES_ENVIO = 68;
const int MSGQUEUE_ORDENES_SOCKET = 69;
const int MSGQUEUE_ORDENES_LECTURA = 70;

const int MSGQUEUE_DESPACHADOR = 71;
const int MSGQUEUE_PLANILLA = 72;
