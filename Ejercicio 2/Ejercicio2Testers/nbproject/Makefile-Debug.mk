...
${OBJECTDIR}/Tecnico.o: Tecnico.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tecnico.o Tecnico.cpp

${OBJECTDIR}/TesterA.o: TesterA.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TesterA.o TesterA.cpp

${OBJECTDIR}/TesterB.o: TesterB.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TesterB.o TesterB.cpp

${OBJECTDIR}/common/AtendedorDispositivos.o: common/AtendedorDispositivos.cpp 
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/AtendedorDispositivos.o common/AtendedorDispositivos.cpp

${OBJECTDIR}/common/AtendedorTesters.o: common/AtendedorTesters.cpp 
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/AtendedorTesters.o common/AtendedorTesters.cpp
...
${OBJECTDIR}/common/Programa.o: common/Programa.cpp 
	${MKDIR} -p ${OBJECTDIR}/common
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/common/Programa.o common/Programa.cpp
...
${OBJECTDIR}/iniciador.o: iniciador.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/iniciador.o iniciador.cpp

${OBJECTDIR}/ipc/Semaphore.o: ipc/Semaphore.cpp 
	${MKDIR} -p ${OBJECTDIR}/ipc
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ipc/Semaphore.o ipc/Semaphore.cpp
...
${OBJECTDIR}/sync/LockFile.o: sync/LockFile.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/sync/LockFile.o sync/LockFile.cpp

${OBJECTDIR}/terminador.o: terminador.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/terminador.o terminador.cpp
